                    ...
                    <div className="flex flex-col grow p-5 space-y-3.75 bg-white rounded-2xl">
                        <div className="grow">
                            {step === 1 &&
                                <div className={'grid grid-cols-1 gap-2.5'}>
                                    ...
                                    <div
                                        className="flex items-center rounded bg-blue-500 text-white text-sm font-bold px-4 py-3"
                                        role="alert">
                                        ...
                                        <p>Token amount should be entered in the CSV as whole amounts. For example; to
                                            receive 1.000 tokens. Enter 1000 as
                                            amount.</p>
                                    </div>
                                </div>
                            ...
                            {step === 2 &&
                                <div
                                    ...
                                    <AddressAndAmountTable tokenImage={project.image} addresses={addresses}
                                                           amounts={amounts}/>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mb-5">
                                        <div>
                                            <div className={'flex flex-row'}>
                                                ...
                                                <i data-tip="Please enter the batchname"
                                                   className="fa-regular fa-circle-info text-sky-500 text-base cursor-pointer"/>
                                            </span>
                                            </div>
                                            <InputEmpty
                                                id="batchname"
                                        ...
                                        <div>
                                            <div className={'flex flex-row'}>
                                                ...
                                                <span
                                                    className="relative flex flex-col items-center justify-center group">
                                                <i data-tip="Please select start date"
                                                   className="fa-regular fa-circle-info text-sky-500 text-base cursor-pointer"/>
                                            </span>
                                            </div>
                                            <div className="mt-3">
                                        ...
                                        <div>
                                            <div className={'flex flex-row'}>
                                                <label className={'pr-2'}
                                                       htmlFor="duration">Duration {durationInDays}</label>

                                                <span
                                                    className="relative flex flex-col items-center justify-center group">
                                                <i data-tip="This is duration"
                                                   className="fa-regular fa-circle-info text-sky-500 text-base cursor-pointer"/>
                                            </span>
                                            </div>
                                            <InputTime
                                        ...
                                        <div>
                                            <div className={'flex flex-row'}>
                                                <label className={'pr-2'} htmlFor="slicePeriodSeconds">Slice Period in
                                                    seconds {slicePeriodSecondsInDays}</label>

                                                <span
                                                    className="relative flex flex-col items-center justify-center group">
                                                <i data-tip="This is slice period in seconds"
                                                   className="fa-regular fa-circle-info text-sky-500 text-base cursor-pointer"/>
                                            </span>
                                            </div>
                                            <InputTime
                        ...
                        <div className="flex flex-row space-x-5">
                            ...
                            {step < 3 ?
                                ...
                                /> :
                                <ButtonWithApproval disabled={isLoading} isLoading={isLoading}
                                                    name="Create Vesting batch - " handleClick={createVesting}
                                                    address={marketMakingPool.address}
                                                    token={marketMakingPool.token} amount={totalAmount} ticker={project.ticker}/>
                            }
                        </div>
                    </div>
                </div>
