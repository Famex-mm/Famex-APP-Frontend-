    ...
    return (
        <div className="relative h-[100%]">
            ...
            <div
                ...
                >
                <div className="px-3.75 max-w-66.25 bg-light-yellow-500 bg-light-yellow-500 xl:bg-light-yellow-500/50 h-[100vh] z-1500">
  ...
  if(props.handleClick) {
      ...
      return (
          <Link href={props.href}>
              <a
                  className={`link flex items-center font-light text-base rounded-xl transition p-3 hover:cursor-pointer ${
                      router.asPath == props.href
                          ? "bg-gradient-to-r from-[#6EE0FF] to-[#FFDE99] text-black"
