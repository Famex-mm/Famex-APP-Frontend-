        ...
        <>
            ...
            <div className="grid grid-cols-1 md-lg:grid-cols-3 gap-5">
                <HomeCard 
                    ...
                    title={i18n.en.management.manage.information.title}
                    content={i18n.en.management.manage.information.description}
                    handleClick={() => setOpenEditProject(true)}
                />

                <HomeCard 
                    icon={<i className="fa-solid fa-pen-paintbrush text-2xl text-indigo-500"></i>}
                    title={i18n.en.management.manage.articles.title}
                    content={i18n.en.management.manage.articles.description}
                ...
                <HomeCard 
                    ...
                    title={i18n.en.management.manage.message.title}
                    content={i18n.en.management.manage.message.description}
                    handleClick={(e) => { router.push(`${project.slug}/message`) }}
                />

                <HomeCard
                    icon={<i className="fa-solid fa-messages text-2xl text-indigo-500"></i>}
                    title={i18n.en.management.manage.history.title}
                    content={i18n.en.management.manage.history.description}
                    handleClick={(e) => { router.push(`${project.slug}/message/history`) }}
                />

                <HomeCard
                    icon={<i className="fa-solid fa-trophy text-2xl text-indigo-500"></i>}
                    title={i18n.en.management.manage.insights.title}
                    content={i18n.en.management.manage.insights.description}
